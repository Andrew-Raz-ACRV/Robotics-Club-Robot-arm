...
from RobotarmKinematics_module import update_joints, DH_matrix, ForwardKinematics,
compute_error, compute_Jacobian, damped_least_squares

from RobotarmUtility_module import read_keyboard, move_arm, Move_arm_to_home,
Reset_robot_arm, read_arm, Initialise_Robot_arm, robotarmLimits
...
if __name__ == "__main__":
    ...
    #When the user kiils the while loop, reset the robot and turn off 
