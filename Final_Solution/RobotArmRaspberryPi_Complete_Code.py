...
from RobotarmUtility_module import read_keyboard, protect_gripper, move_arm, Move_arm_to_home, Reset_robot_arm, read_arm, Initialise_Robot_arm, robotarmLimits
...
if __name__ == "__main__":
    ...
    while(on):
        ...
        (Desired_pose,grip_value,on) = read_keyboard(Desired_pose,old_grip_value,on)
        ...
        #Protect the gripper servo as it overheats
        #by switching it off after use
        old_grip_value = protect_gripper(old_grip_value,grip_value,m5,bus)
